      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 select-none pointer-events-auto">
          ...
          >
            ...
            {/* 2. Main Content Body */}
            <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar px-3 sm:px-4 py-2.5 grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5">
              {/* VIEW 1: Main Menu List */}
              {currentView === 'menu' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5 animate-in fade-in duration-200">
              ...
              {currentView === 'history' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5 animate-in fade-in duration-200">
                  ...
                  {sessions.length === 0 ? (
                    <div className="p-6 text-center rounded-2xl bg-white/70 border border-slate-200/80 text-slate-400 grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1">
              ...
              {currentView === 'connectors' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 animate-in fade-in duration-200 text-start">
                  {selectedConnector && currentConnectorDef ? (
                    isSelectedConnected ? (
                      ...
                      <div className="space-y-3 animate-in fade-in duration-200">
                        ...
                        <div className="p-4 rounded-3xl bg-gradient-to-br from-white via-sky-50/60 to-emerald-50/50 border border-emerald-300/80 shadow-[0_8px_24px_rgba(16,185,129,0.12)] space-y-3 relative overflow-hidden">
                          ...
                          <div className="p-3 rounded-2xl bg-white/90 border border-slate-200/80 shadow-2xs grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5 animate-in fade-in duration-200">
                        ...
                        <div className="p-3.5 rounded-2xl bg-gradient-to-br from-blue-50/90 via-white to-sky-50/80 border border-blue-200/90 shadow-2xs grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5">
                          <div className="flex items-center justify-between">
                    ...
                    <>
                      ...
                      <div className="p-3 sm:p-3.5 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-950 text-white border border-blue-500/40 shadow-md grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5 animate-in fade-in duration-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1">
                    ...
                    {(galleryFilter === 'all' || galleryFilter === 'html') && (
                      <div className="p-3 rounded-2xl bg-white border border-sky-200/80 hover:border-emerald-400 shadow-2xs hover:shadow-xs transition-all grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 group text-start">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                    ...
                    {(galleryFilter === 'all' || galleryFilter === 'image') && (
                      <div className="p-3 rounded-2xl bg-white border border-sky-200/80 hover:border-rose-400 shadow-2xs hover:shadow-xs transition-all grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 group text-start">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                    ...
                    {(galleryFilter === 'all' || galleryFilter === 'video') && (
                      <div className="p-3 rounded-2xl bg-white border border-sky-200/80 hover:border-purple-400 shadow-2xs hover:shadow-xs transition-all grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 group text-start">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                    ...
                    {(galleryFilter === 'all' || galleryFilter === 'coding') && (
                      <div className="p-3 rounded-2xl bg-white border border-sky-200/80 hover:border-amber-400 shadow-2xs hover:shadow-xs transition-all grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1 group text-start">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
              ...
              {currentView === 'stats' && (
                <div className="space-y-3 animate-in fade-in duration-200 text-start">
                  {/* Level & XP Card */}
                  <div className="p-4 rounded-3xl bg-gradient-to-br from-blue-600 via-sky-600 to-indigo-700 text-white shadow-[0_8px_24px_rgba(37,99,235,0.32)] grid grid-cols-1 md:grid-cols-2 gap-3 overflow-y-auto max-h-[480px] pr-1.5 relative overflow-hidden">
                    <div className="absolute top-0 inset-x-4 h-[1.5px] bg-gradient-to-r from-transparent via-white/80 to-transparent pointer-events-none rounded-full" />
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
